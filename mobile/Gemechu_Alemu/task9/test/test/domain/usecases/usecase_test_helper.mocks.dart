...
// in task9/test/test/domain/usecases/usecase_test_helper.dart.
...
import 'package:task9/domain/entities/product.dart' as _i2;
import 'package:task9/domain/repositories/product_repository.dart' as _i3;
...
class MockProductRepository extends _i1.Mock implements _i3.ProductRepository {
  ...
  @override
  _i4.Future<_i2.Product> getProduct(String? id) =>
      (super.noSuchMethod(
